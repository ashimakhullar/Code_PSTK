...
namespace IO.Swagger.Model
{
    ...
    public partial class ValidateError :  IEquatable<ValidateError>, IValidatableObject
    {
        ...
        public ValidateError(int? Code = default(int?), string Message = default(string))
        {
            // to ensure "Code" is required (not null)
            if (Code == null)
            {
                throw new InvalidDataException("Code is a required property for ValidateError and cannot be null");
            }
            else
            {
                this.Code = Code;
            ...
            if (Message == null)
            {
                throw new InvalidDataException("Message is a required property for ValidateError and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ValidateError);
        }

        /// <summary>
        /// Returns true if ValidateError instances are equal
        /// </summary>
        /// <param name="other">Instance of ValidateError to be compared</param>
        /// <returns>Boolean</returns>
